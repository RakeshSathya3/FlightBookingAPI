...
namespace AirlineService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<FlightApplicationDBContext>(options => options.UseSqlServer(Configuration.GetConnectionString("FlightApplicationConnection")));
            ...
            services.AddMassTransit(x =>
            {
                ...
                x.AddRider(rider =>
                {
                    ...
                    rider.UsingKafka((context, k) =>
                    {
                        ...
                        k.TopicEndpoint<InventoryChangeDetails>(nameof(InventoryChangeDetails), GetUniqueName(nameof(InventoryChangeDetails)), e =>
                        {
